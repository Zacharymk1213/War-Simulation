...
def game():
    ...
    commanders = [YiddisheCommander((names[0].get_text()),float((strengths[0].get_text())),(defenses[0].get_text()),(healths[0].get_text())),YiddisheCommander((names[1].get_text()),float((strengths[1].get_text())),(defenses[1].get_text()),(healths[1].get_text())),YiddisheCommander((names[2].get_text()),float((strengths[2].get_text())),(defenses[2].get_text()),(healths[2].get_text()))]
    enemies = [Enemy((names[3].get_text()), (strengths[3].get_text()), (defenses[3].get_text()), (healths[3].get_text())), Enemy((names[4].get_text()), (strengths[4].get_text()), (defenses[4].get_text()), (healths[4].get_text())), Enemy((names[5].get_text()), (strengths[5].get_text()), (defenses[5].get_text()), (healths[5].get_text())), Enemy ((names[6].get_text()), (strengths[6].get_text()), (defenses[6].get_text()), (healths[6].get_text())), Enemy ((names[7].get_text()),(strengths[7].get_text()),(defenses[7].get_text()),(healths[7].get_text())),Enemy((names[8].get_text()),(strengths[8].get_text()),(defenses[8].get_text()),(healths[8].get_text()))]
