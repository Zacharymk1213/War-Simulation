...
soundObj = pygame.mixer.Sound(resource_path('music.mp3'))
...
print_slow("By Zachary Gaming inc.")
time.sleep(0)
print ("\n" * 50)
...
class YiddisheCommander:
    ...
    def attack_enemy(self,Enemy):
        ...
        if answer == "1":
            ...
            Enemy.health = Enemy.health - (self.strength * random.uniform(0.1, 2.0))
            Enemy.health = int(Enemy.health)
        elif answer == "3":
...
class Enemy:
    ...
    def enemy_attack(self,commanders):
        ...
        print("")
        commanders.health = commanders.health - (self.strength * random.uniform(0.1, 2.0))
    ...
    def battle_script(self,commanders):
        ...
        print ("")
        time.sleep(1)
        while commanders.health > 0 and self.health > 0:
...
commanders = [YiddisheCommander("Bar Kochba",40,40,100),YiddisheCommander("Yeshua ben Galgula",30,50,100),YiddisheCommander("Masbelah ben Shimon",25,25,100)]
enemies = [Enemy(" Tineius Rufus", 2, 6, 65), Enemy("Sextus Julius Severus", 20, 50, 100), Enemy("Publicius Marcellus", 17, 40, 100), Enemy ("T. Haterius Nepos", 20, 30, 100), Enemy ("Q. Lollius Urbicus",12,30,100),Enemy("Hadrian",80,40,100)]
